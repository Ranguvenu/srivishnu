...
// Custom code to show dashboard layout by role - starts
if(!is_siteadmin() && has_capability('block/studentdashboard:view', $systemcontext)){
    $PAGE->set_pagelayout('studentdashboard');
}elseif(!is_siteadmin() && has_capability('block/facultydashboard:view', $systemcontext)){
    $PAGE->set_pagelayout('facultydashboard');
}else{
    $PAGE->set_pagelayout('mydashboard');
}
// Custom code to show dashboard layout by role -  ends
...
if (!is_siteadmin()) {
    ...
    if($roleshortname == 'hod' || $roleshortname == 'principal'){
        !empty($userroles) ? redirect($CFG->wwwroot . '/blocks/reportdashboard/dashboard.php?role='.$roleshortname.'&contextlevel='.$rolecontextlevel.'&dashboardurl='.$dashboardurl.'') :redirect($CFG->wwwroot . '/blocks/reportdashboard/dashboard.php?dashboardurl='.$dashboardurl.'');
    }
}
echo $OUTPUT->header();
