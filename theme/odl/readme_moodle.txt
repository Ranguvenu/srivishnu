...
* remove folder theme/odl/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/odl/scss/bootstrap
...
* comment out this line in theme/odl/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/odl/amd/src/bootstrap (including the subfolder)
...
* in folder theme/odl run "Grunt amd" to compile the bootstrap JS
