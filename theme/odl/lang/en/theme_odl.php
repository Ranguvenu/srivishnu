...
$string['loginbg_desc'] = 'The image to display as a background of the Login page. The background image you upload here will override the background image in your theme preset files.';

$string['brandcolor'] = 'Brand colour';
$string['brandcolor_desc'] = 'The accent colour.';
$string['choosereadme'] = 'odl is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['bootswatch'] = 'Bootswatch';
$string['bootswatch_desc'] = 'A bootswatch is a set of Bootstrap variables and css to style Bootstrap';
$string['choosereadme'] = 'odl is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'odl';
$string['generalsettings'] = 'General settings';
$string['nobootswatch'] = 'None';
$string['customsettings'] = 'Custom settings';
$string['colorsettings'] = 'Color settings';
$string['pluginname'] = 'odl';
$string['presetfiles'] = 'Additional theme preset files';
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href="https://docs.moodle.org/dev/odl_Presets">odl presets</a> for information on creating and sharing your own preset files, and see the <a href="https://archive.moodle.net/odl">Presets repository</a> for presets that others have shared.';
$string['preset'] = 'Theme preset';
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme.';
$string['privacy:metadata'] = 'The odl theme does not store any personal data about any user.';
...
$string['loginlogo_desc'] = 'The Logo you uploaded here will be displayed on Login Page';

$string['logindesc'] = 'Login Desc'; 
$string['logindesc_desc'] = 'The Text you uploaded here will be displayed under the Login page Logo';
...
$string['slider1desc'] = 'The uploaded image will displayed as first slider for login page only';

$string['slider2'] = 'Login Slider2';
$string['slider2desc'] = 'The uploaded image will displayed as second slider for login page only';

$string['slider3'] = 'Login Slider3';
$string['slider3desc'] = 'The uploaded image will displayed as third slider for login page only';

$string['slider4'] = 'Login Slider4';
$string['slider4desc'] = 'The uploaded image will displayed as fourth slider for login page only';

$string['slider5'] = 'Login Slider5';
$string['slider5desc'] = 'The uploaded image will displayed as fifth slider for login page only';
...
$string['region-stu_lay_full'] = 'Student full region';
$string['region-stuleftreg'] = 'Student left region';
$string['region-sturightreg'] = 'Student right region';

$string['region-faclay_full'] = 'Faculty full region';
$string['region-facleftreg'] = 'Faculty left region';
$string['region-facrightreg'] = 'Faculty right region';
