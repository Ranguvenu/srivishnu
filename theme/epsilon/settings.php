...
if ($ADMIN->fulltree) {
    ...
    $name = 'theme_epsilon/loginbg';
    $title = get_string('loginbg', 'theme_epsilon');
    $description = get_string('loginbg_desc', 'theme_epsilon');
    ...
    $name = 'theme_epsilon/bodybgcolor';
    $title = get_string('bodybgcolor', 'theme_epsilon');
    $description = get_string('bodybgcolor_desc', 'theme_epsilon');
    $default = '#f5f4f1';
