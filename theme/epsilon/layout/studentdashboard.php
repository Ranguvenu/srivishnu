...
$stulayerone_detail_full = $OUTPUT->blocks('stu_lay_full', 'col-md-12');
$studentleftregion = $OUTPUT->blocks('stuleftreg', 'col-md-6');
$studentrightregion = $OUTPUT->blocks('sturightreg', 'col-md-6');
...
$templatecontext = [
    ...
    'studentleftregion' => $studentleftregion,
    'studentrightregion' => $studentrightregion,
    'stulayerone_detail_full' => $stulayerone_detail_full,
...
echo $OUTPUT->render_from_template('theme_epsilon/studentdashboard', $templatecontext);
