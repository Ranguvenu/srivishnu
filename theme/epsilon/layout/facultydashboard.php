...
$faclayerone_detail_full = $OUTPUT->blocks('faclay_full', 'col-md-12');
$facultyleftregion = $OUTPUT->blocks('facleftreg', 'col-md-7');
$facultyrightregion = $OUTPUT->blocks('facrightreg', 'col-md-5');
...
$templatecontext = [
    ...
    'facultyleftregion' => $facultyleftregion,
    'facultyrightregion' => $facultyrightregion,
    'faclayerone_detail_full' => $faclayerone_detail_full,
...
echo $OUTPUT->render_from_template('theme_epsilon/facultydashboard', $templatecontext);
