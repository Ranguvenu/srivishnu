...
/*Activite Courses with gradable activities */
$string['report_coursewithgradable'] = 'Active Courses BY Gradable Activities';
$string['report_coursewithgradable_help'] = 'Active Courses BY Gradable Activities';
$string['coursewithgradable'] = 'Active Courses BY Gradable Activities';

$string['report_coursefiles'] = 'Active courses by file uploads';
$string['report_coursefiles_help'] = 'Active courses by file uploads';
$string['coursefiles'] = 'Active courses by file uploads';
$string['coursefilecolumns'] = 'File upload columns';
$string['report_inactivecourses'] = 'Inactive courses';
$string['report_inactivecourses_help'] = 'Inactive courses';
$string['inactivecourses'] = 'Inactive courses';
$string['inactivecoursecolumns'] = 'Inactive course columns';
$string['report_activefaculty'] = 'Active Faculty';
$string['activefaculty'] = 'Active Faculty';
$string['report_activefaculty_help'] = 'Active Faculty';
$string['activefacultycolumns'] = 'Active faculty columns';
$string['report_inactivefaculty'] = 'InActive Faculty';
$string['report_inactivefaculty_help'] = 'InActive Faculty';
$string['inactivefacultycolumns'] = 'InActive Faculty Columns';

/*Faculty Filter*/
$string['filter_faculty'] = 'Select Faculty';
$string['filterfaculty'] = 'Faculty';
$string['faculty'] = 'Faculty';
$string['lsreports'] = 'Analytics';

$string['filtercollege'] = 'Select College';
$string['filtercollege_summary'] = 'Select College';
$string['filter_college'] = 'Select College';
$string['college'] = 'College';
$string['filterdepartment'] = 'Select Department';
$string['filterdepartment_summary'] = 'Select Department';
$string['filter_department'] = 'Select Department';
$string['department'] = 'Department';
$string['filterprogram'] = 'Select Program';
$string['filterprogram_summary'] = 'Select Program';
$string['filter_program'] = 'Select Program';
