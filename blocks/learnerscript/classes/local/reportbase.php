...
class reportbase {
    ...
    function __construct($report, $properties = null) {
        ...
        $this->collegeid = isset($this->collegeid) && $this->collegeid > 0 ? $this->collegeid : 0;
        $this->departmentid = isset($this->departmentid) && $this->departmentid > 0 ? $this->departmentid : 0;
   ...
   public function build_query($count = false) {
    ...
    if($this->reporttype == 'table'){
        if(is_siteadmin($this->userid) || (new ls)->is_manager($this->userid, $this->contextlevel, $this->role)){
            ...
            if(((!is_siteadmin() && !has_capability('local/costcenter:manage_multiorganizations', $context)) && has_capability('local/costcenter:manage_ownorganization',$context) && has_capability('block/learnerscript:managelsreports',$context)) || (!has_capability('local/costcenter:manage_ownorganization',$context) && has_capability('local/costcenter:manage_owndepartments',$context) && has_capability('block/learnerscript:managelsreports',$context)) || ((!is_siteadmin() && !has_capability('local/costcenter:manage_multiorganizations', $context)) && !has_capability('local/costcenter:manage_ownorganization',$context) && has_capability('block/learnerscript:managelsreports',$context) && has_capability('block/learnerscript:manageownreports',$context)) || (!has_capability('local/costcenter:manage_ownorganization',$context) && !has_capability('local/costcenter:manage_owndepartments',$context) && !has_capability('block/learnerscript:managelsreports',$context) && has_capability('block/learnerscript:manageownreports',$context))){
                try {
                $this->totalrecords = $DB->count_records_sql($this->sql, $this->params);
                } catch (dml_exception $e) {
                    $this->totalrecords = 0;
