...
class plugin_courses extends plugin_base{
    ...
    public function init() {
        ...
        $this->reporttypes = array('courses', 'sql', 'courseactivities');
    }
    ...
    public function print_filter(&$mform) {
       ...
       /* if (!empty($courselist)) {
            ...
            $courses = $DB->get_records_sql("SELECT c.id,c.fullname FROM {course} c JOIN {local_cc_semester_courses} lcc ON c.id = lcc.courseid WHERE c.visible = 1 AND lcc.programid =".$filter_program);
