...
define(['local_courses/jquery.dataTables', 'jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
     ...
     */
    var Newcollege = function(selector, contextid, id, underuniversity) {
     ...
     * @private
     */
    Newcollege.prototype.modal = null;

    /**
     * @var {int} contextid
     * @private
     */
    Newcollege.prototype.contextid = -1;
     ...
     * @return {Promise}
     */
    Newcollege.prototype.init = function(selector) {
        ...
        // $(selector).click(function(){
            ...
            //  self.categoryid = editid;
              //alert(self.courseid);
            if (self.id) {
                var head =  Str.get_string('editcollege', 'local_colleges');
            }else{
               var head =  Str.get_string('addcollege', 'local_colleges');
            }
     ...
     * @return {Promise}
     */
    Newcollege.prototype.getBody = function(formdata) {
        ...
        return Fragment.loadFragment('local_courses', 'college_form', this.contextid, params);
    };
     Newcollege.prototype.getFooter = function() {
        console.log(this);
        if(this.id){
     ...
     * @return {Promise}
     */
    Newcollege.prototype.handleFormSubmissionResponse = function() {
        this.modal.hide();
     ...
     * @return {Promise}
     */
    Newcollege.prototype.handleFormSubmissionFailure = function(data) {
        // Oh noes! Epic fail :(
     ...
     */
    Newcollege.prototype.submitFormAjax = function(e) {
        ...
        console.log(JSON.stringify(formData));
        Ajax.call([{
            methodname: 'local_courses_submit_create_college_form',
     ...
     * @private
     */
    Newcollege.prototype.submitForm = function(e) {
        e.preventDefault();
        var self = this;
    ...
    return /** @alias module:local_course/newcourse */ {
        ...
        init: function(args) {
            console.log(args);
            return new Newcollege(args.selector, args.contextid,args.id,args.underuniversity);
        },
