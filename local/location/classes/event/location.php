...
class location{
    ...
    public function room_update_instance($roomdata){
    	global $DB;
      // print_object($roomdata);exit;
      $roomdata->costcenter = $roomdata->costcenter;
      $roomdata->subcostcenter = $roomdata->subcostcenter;
      $roomdata->instituteid = $roomdata->location;
    ...
    public function set_data_institute($id){
      ...
      $userdata=$DB->get_record('local_location_institutes',array('id'=>$id));
          ...
          $record->subcostcenter = $userdata->subcostcenter;
    ...
    public function institute_insert_instance($data){
        global $DB, $CFG, $USER;
          ...
          $record->subcostcenter = $data->subcostcenter;
    ...
    public function room_insert_instance($roomdata){
        global $DB, $CFG, $USER;
          $record = new stdClass();
          $record->costcenter = $roomdata->costcenter;
          $record->subcostcenter = $roomdata->subcostcenter;
          $record->instituteid = $roomdata->location;
