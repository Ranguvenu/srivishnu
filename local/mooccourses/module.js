...
M.local_mooccourses = M.local_mooccourses || {};
// Define a user selectors array for against the cure_user namespace
M.local_mooccourses.user_selectors = [];
/**
 ...
 * @return bool
 */
M.local_mooccourses.get_user_selector = function (name) {
 ...
 */
M.local_mooccourses.init_user_selector = function (Y, name, hash, extrafields, lastsearch) {
    ...
    var user_selector = {
        ...
        output_options : function(data) {
            ...
            if (!count) {
                var searchstr = (this.lastsearch != '') ? this.insert_search_into_str(M.util.get_string('nomatchingcolleges', 'local_program'), this.lastsearch) : M.util.get_string('none', 'moodle');
            ...
            if (this.get_option('preserveselected') && selectedusers) {
                this.output_group(this.insert_search_into_str(M.util.get_string('previouslyselectedcolleges', 'local_program'), this.lastsearch), selectedusers, true, false);
            }
 ...
 */
M.local_mooccourses.init_user_selector_options_tracker = function(Y) {
