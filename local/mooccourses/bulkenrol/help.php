...
$PAGE->set_url('/local/mooccourse/bulkenrol/help.php');
...
$PAGE->navbar->add(get_string('uploadenrol', 'local_mooccourses'), new moodle_url('/local/mooccourses/bulkenrol/bulkuploadcron.php'));
...
if (isset($CFG->allowframembedding) and ! $CFG->allowframembedding) {
    ...
    echo '<div style="float:right;"><a href="bulkuploadcron.php"><button>' . get_string('back_upload', 'local_mooccourses') . '</button></a></div>';
}
echo get_string('help', 'local_mooccourses');
