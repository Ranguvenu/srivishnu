...
if($action=='facultieslist' && $costcenterid){
    $faculties_sql = "SELECT id, facultyname FROM {local_faculties} WHERE university = $costcenterid";
    $data = $DB->get_records_sql($faculties_sql);
    echo json_encode(['data' => $data]);
}
