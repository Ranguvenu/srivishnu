 ...
 * @package    local
 * @subpackage courses
 * @copyright  2017 eAbyas <www.eabyas.in>
...
Class custom_filter extends moodleform{
	...
	public function get_all_users_emails($costcenter,$data = false){
		...
		if($data){
			...
			if($costcenter){
				$sql = "select u.id,u.email from {user} as u where u.deleted = 0 and u.suspended = 0 and u.id>2 and u.open_costcenterid=$costcenter"; 
			}else{
   ...
   /**End of the code**/
	...
	public function get_category_list($costcenter){
		 ...
		 $systemcontext = context_system::instance();
			...
			}elseif(!is_siteadmin() && has_capability('local/costcenter_course:enrol', $systemcontext)){
