...
function export_report($curriculumid, $stable, $type) {
    ...
    if($type == 'curriculumwise') {
        ...
        $table->head = array(get_string('employee', 'local_program'), get_string('curriculum_name', 'local_program'), get_string('employeeid', 'local_program'), get_string('email'),get_string('supervisor', 'local_program'),get_string('noofsemesters', 'local_program'), get_string('status'));
        ...
        $table->head = array(get_string('employee', 'local_program'), get_string('employeeid', 'local_program'), get_string('email'), get_string('curriculum_name', 'local_program'),get_string('course', 'local_program'),get_string('session_name', 'local_program'), get_string('status'), 'Date');
    }
