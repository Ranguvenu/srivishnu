...
/**
 * The local_classroom post updated event.
 *
...
class classroom_completions_settings_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventclassroomcompletions_settings_updated', 'local_program');
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'local_cc_semester_classrooms', 'restore' => 'local_classroom');
    }
