...
foreach ($sessions as $session) {
	...
	if($get_notifications_emp){
	    ...
	    $dataobj->program_startdate = date('d-m-Y',$program->startdate);
	    $dataobj->program_enddate = date('d-m-Y',$program->enddate);
	    ...
	    $dataobj->program_session_startdate = date('d-m-Y',$data->timestart);
	    $dataobj->program_session_enddate = date('d-m-Y',$data->timefinish);
