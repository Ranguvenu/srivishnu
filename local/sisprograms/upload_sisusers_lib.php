...
class uu_progress_tracker {
    ...
    private $_row;
    public $columns = array('student_prn','coursecode', 'firstname','lastname','email', 'mobile','address','country','city','dob','gender','role');
 ...
 */
function uu_validate_enrollment_upload_columns(csv_import_reader $cir, $stdfields, $profilefields, moodle_url $returnurl) {
