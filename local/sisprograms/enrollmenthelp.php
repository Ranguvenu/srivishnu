...
$PAGE->navbar->add(get_string('uploadenrollments', 'local_sisprograms'), new moodle_url('/local/sisprograms/upload.php'));
...
if (isset($CFG->allowframembedding) and ! $CFG->allowframembedding) {
    ...
    echo '<div class="pull-right help-btn"><a href="uploadusers.php"><button>' . get_string('back_upload', 'local_sisprograms') . '</button></a></div>';
}
if (isset($CFG->allowframembedding) and ! $CFG->allowframembedding) {
    echo '<b >' . $OUTPUT->box('<p style="color:red;">' . get_string('delimited', 'local_sisprograms') . '</p>') . '</b>';
}

echo get_string('enrolmenthelp_tab', 'local_sisprograms');
