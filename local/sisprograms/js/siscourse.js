 ///for sis courses
    ...
    var tableContainer = $('#siscoursestable');
    $("#siscoursestable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#siscoursestable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    var oTable = tableContainer.dataTable({
        ...
        "bInfo": false,
        "oLanguage": {
            "sEmptyTable": "No Courses available in table",
            "oPaginate": {
                "sFirst": "<<",
                "sLast": "  >>  ",
                "sNext": "  >",
    ...
    oTable.coFilter({
        ...
        aoColumns: [0, 2, 3],
        columntitles: {0: "Course",2: "Program", 3: "Organization"},
