...
define(['jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
     ...
     */
    var DelDepartment = function(selector, contextid, categoryid, coursescount) {
     ...
     * @private
     */
    DelDepartment.prototype.modal = null;
 
    /**
     * @var {int} contextid
     * @private
     */
    DelDepartment.prototype.contextid = -1;
     ...
     * @return {Promise}
     */
    DelDepartment.prototype.init = function(selector) {
     ...
     * @return {Promise}
     */
    DelDepartment.prototype.getBody = function(formdata) {
     ...
     * @return {Promise}
     */
    DelDepartment.prototype.handleFormSubmissionResponse = function() {
        this.modal.hide();
     ...
     * @return {Promise}
     */
    DelDepartment.prototype.getFooter = function() {
        $footer = '';
        if(this.count == 0){
     ...
     * @return {Promise}
     */
    DelDepartment.prototype.handleFormSubmissionFailure = function(data) {
        // Oh noes! Epic fail :(
     ...
     */
    DelDepartment.prototype.submitFormAjax = function(e) {
     ...
     * @private
     */
    DelDepartment.prototype.submitForm = function(e) {
        e.preventDefault();
        var self = this;
    ...
    return /** @alias module:local_evaluation/newevaluation */ {
         ...
         */
        init: function(args) {
            return new DelDepartment(args.selector, args.contextid,args.categoryid,args.count);
        },
        load: function() {
        }
    };
